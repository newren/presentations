...
\begin{frame}
  ...
  \begin{itemize}[<+->]
     ...
     \item Rebase or cherry-pick hwmon-updates (35 patches) from 5.5 $\to$ 5.4

     \item Very few renames involved; only takes 50\% of execution time

     \item Speedup factor of 3 (optimized more things than renames)

     \item What if we checkout 5.4, and rename \texttt{drivers/}
           $\Rightarrow$ \texttt{pilots/}, and then rebase or cherry-pick
           those 35 patches on top ?
...
\begin{frame}
  ...
  \vfill
  \begin{center}
  Reproduce these numbers:\\[2\baselineskip]
